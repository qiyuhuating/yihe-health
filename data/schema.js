...
(function (g) {
  ...
  var FIELDS = {
    ...
    mobility:     { type: "number", min: 0, max: 1, default: 0 },
    careLevel:    { type: "string", default: "自理" },
    ...
    medicalHistory: {
      ...
      fields: {
        ...
        allergies:       { type: "string", default: "无" },
        medications:     { type: "string", default: "" },
        surgicalHistory: { type: "string", default: "无" },
        familyHistory:   { type: "string", default: "" },
        smoking:         { type: "string", default: "无" },
        alcohol:         { type: "string", default: "无" },
        bloodType:       { type: "string", default: "—" },
        lastCheckup:     { type: "string", default: "" }
      }
    },
    slots: {
      type: "array",
  ...
  function validate(rec) {
    var errors = [];
    if (!rec || typeof rec !== "object") return { ok: false, errors: ["记录不是对象"] };
  ...
  var API = { FIELDS: FIELDS, REQUIRED: REQUIRED, normalize: normalize, validate: validate };
