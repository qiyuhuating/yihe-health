...
(function () {
  ...
  function siteIcon(name, size, color) {
    ...
    var s = size || 24, c = color || "currentColor";
  ...
  /* ---------- 1. 导航与页脚结构 ---------- */
  var NAV = [
    { href: "home.html", label: "首页", icon: "home" },
    { href: "about.html", label: "机构简介", icon: "intro" },
    { href: "services.html", label: "服务内容", icon: "service" },
    { href: "news.html", label: "养老资讯", icon: "news" },
    { href: "guide.html", label: "入住指南", icon: "guide" },
    { href: "contact.html", label: "联系我们", icon: "contact" }
  ];
  ...
  function bindThemeToggle() {
    ...
    btn.addEventListener("click", function () {
      ...
      try { localStorage.setItem("yihe-theme", next); } catch (e) {}
  ...
  function bindFontCtrl() {
    ...
    var saved = 1;
    try { saved = parseFloat(localStorage.getItem("yihe-text-scale")) || 1; } catch (e) {}
    ...
    document.querySelectorAll("[data-font]").forEach(function (b) {
      b.addEventListener("click", function () {
        ...
        try { localStorage.setItem("yihe-text-scale", v); } catch (e) {}
      });
    });
  }
